        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="flex flex-col items-center justify-center h-screen w-full">
            ...
            <div className="flex flex-row items-center justify-center space-x-4 mt-4">
              <button onClick={() => router.push('/login')} className="px-6 py-3 rounded-lg bg-[#005B41] hover:bg-[#008170] text-white text-base font-semibold transition-colors duration-300">
                Cheque In
              </button>
